---
layout: default
title : Docker et cycle de vie
date:   2020-03-10 23:00:00 +0100
---
...
- Existe-t-il des corélations entre les différents types de paramètres ?
...
- Existe-t-il des liens entre les différents types de paramètres de haut niveau ?
    ...
    - Au vue des résultats que nous avons obtenus lors de cette étude, nous ne pouvons pas affirmer que ce lien existe.
    
- Existe-t-il des points communs de paramètrage entre plusieurs technologies/langages ?

    - Il en existe, mais seulement pour les cas les plus évidents (le paramètre `expose` par exemple). Pour le reste du paramétrage il n'y a que très peu de points communs.
    
- Existe-t-il des corélations entre les différents types de paramètres ?
    
    - Étant donné la grande hétérogéniété des paramètres utilisés (que ce soit dans le nommage ou l'utilisation), il est difficile de trouver des corélations flagrantes entre les différents types de paramètres.
...
- Les scripts bash `.sh` pour la phase d'instanciation de l'image.
- Et enfin les fichiers markdown pour trouver la commande de lancement du projet.

Puis il va stocker ces différentes données dans un fichier JSON (1 par repository) afin de pouvoir les conserver pour d'autres utilisations.  
...
[Repo Git du projet](https://github.com/AlexBolot/ProjetRIMEL), les listes des projets utilisés sont dans les dossiers:
- [src/generated/go](https://github.com/AlexBolot/ProjetRIMEL/tree/master/src/generated/go)
- [src/generated/java](https://github.com/AlexBolot/ProjetRIMEL/tree/master/src/generated/java)
