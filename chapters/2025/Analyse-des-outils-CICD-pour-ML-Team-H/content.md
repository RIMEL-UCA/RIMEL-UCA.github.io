...
* Axel Delille &lt;Axel.delille@etu.unice.fr&gt;
* Apoorva Srinivas Appadoo &lt;apoorva-srinivas.appadoo@etu.unice.fr&gt;
* Yvann Ponce &lt;Yvann.ponce@etu.unice.fr&gt;
* Fabien Airaud &lt;Fabien.airaud@etu.unice.fr&gt;

## I. Research context /Project

Implementing a continuous integration (CI) and continuous deployment (CD) chain can boost a team's productivity tenfold. An analysis of CI/CD tools for artificial intelligence (AI) would accelerate its development. Today, companies are fighting to get the best model out first. Efficient CI helps achieve this goal.

Also, our team includes several DevOps profiles with a strong interest in CI/CD concepts. This is an opportunity for us to extend our knowledge of the subject to the field of AI.
