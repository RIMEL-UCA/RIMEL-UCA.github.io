...
api_url = "https://api.github.com/search/repositories?q=language:java&sort=stars&size<=30000"
response = req.get(api_url, headers={"Authorization": "Bearer " + auth}).json()
# On récupère le dossier
retro_dir = os.getcwd()
print(str(len(response["items"])) + " projects to analyze...")
