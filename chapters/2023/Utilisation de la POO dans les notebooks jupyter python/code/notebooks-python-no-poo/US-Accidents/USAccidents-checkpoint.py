...
corr = caaccident2019.corr(method='pearson')
fig, ax = plt.subplots(figsize=(9,9))
sns.heatmap(corr, ax = ax,cmap='coolwarm',  robust=True)
ax.set_title('Correlation')
plt.show()
plt.savefig('cacorrelation.png')
caaccidentgg = accidentdata.drop(["Source","TMC", "End_Lat","End_Lng", "Distance(mi)","Description", "Number", "Street", "Side",
                                     ...
                                     "Roundabout","Station", "Stop", "Traffic_Calming","Traffic_Signal","Turning_Loop","Sunrise_Sunset","Civil_Twilight",
                                      ...
                                      "City","Zipcode","End_Time","County","Weather_Timestamp"], axis=1)
caaccidentgg.head()
caplot2019=caaccidentgg[caaccidentgg.State.str.contains('CA')]
caplot2019.head()
newcaplot2019=caplot2019[caplot2019.Start_Time.str.contains('2019')]
newcaplot2019.head()
%matplotlib inline
