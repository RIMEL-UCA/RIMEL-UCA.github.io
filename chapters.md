...
### L’évolution des données dans les projets open-source de Data For Good : une étude de cas historique : [L’évolution des données dans les projets open-source de Data For Good : une étude de cas historique]({{site.url}}/chapters/2026/Etude-Cas-DataForGoodFrance-TeamH/content)
